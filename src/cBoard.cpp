...
void cBoard::Init()
{
	sounds["bird_spawn"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("bird_spawn.wav"));
	sounds["build_statue"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("build_statue.wav"));
	sounds["click"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("click.wav"));
	sounds["cricket_die"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("cricket_die.wav"));
	sounds["cricket_spawn"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("cricket_spawn.wav"));
	sounds["harvest"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("harvest.ogg"));
	sounds["plant"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("plant.ogg"));
	sounds["start_fire"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("start_fire.wav"));
	sounds["fire_spread"].setBuffer(*slGame::inst.resources->LoadSoundBuffer("fire_spread.wav"));
	Reg(slRegister::DRAW | slRegister::UPDATE | slRegister::INPUT);
	background.setTexture(*slGame::inst.resources->LoadTexture("background.png"));
	tilesSpritesheet.setTexture(*slGame::inst.resources->LoadTexture("tiles.png"));
